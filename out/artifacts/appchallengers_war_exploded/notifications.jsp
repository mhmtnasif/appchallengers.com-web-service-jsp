...
<ul class="list-inline" >
    <li><a href="profile.jsp?ref=<%=feed.getFromId()%>">
        <%if(feed.getFromUserProfilePicture()==null || feed.getFromUserProfilePicture()=="" ){%>
        <img src="/images/defaultprofil.png"  class="dairesel">
        <%}else{%>
        <img src="<%=feed.getFromUserProfilePicture()%>"  class="dairesel">
        <%}%>
