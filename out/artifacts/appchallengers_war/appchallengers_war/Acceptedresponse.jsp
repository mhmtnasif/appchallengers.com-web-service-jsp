...
<!-- Bu sayfa kullan�c� kabul etti�i cahllenge lar� g�rmek istegi�inde ajax cevab� olarak
 ...
 <%
   ...
   status=Integer.parseInt(request.getParameter("status"));
     ...
     List<ChallengeResponseModel> userChallengeFeedList2 = getUserInfoDao.getUserAcceptedChallenges(visitorid, userid);
     List<ChallengeResponseModel> userChallengeFeedList = getUserInfoDao.getUserChallenges(visitorid, userid);
