...
<%
    ...
    if(userName==null){
        ...
        userid=users.getId();
        if(request.getParameter("ref")!=null && !String.valueOf(request.getParameter("ref")).equals("") )  {
...
%>
<%if(userName!=null && detailModel.getHeadLine()!=null){%>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        <ul class="list-inline">
                            <li><strong> #</strong></li>
                            <li><strong><%=detailModel.getHeadLine()%></strong></li>
                            <li><strong><%=detailModel.getCounter()%></strong</li>
                        </ul>
                 ...
                 <div class="panel panel-default" id="p<%=feed.getChallenge_detail_id()%>">
                     <div class="panel-heading " style="background-color: #fefefe">
                         <ul class="list-inline">
                             ...
                             <li><strong>></strong></li>
                             <li><div class="tetx-muteed"><%=feed.getHeadline()%></div></li>
                         </ul></div>
                     <div class="panel-body">
...
<script  type="text/javascript">
    ...
    function popular() {
        ...
        $.ajax({
            url:"./challengedetailresponse.jsp",
