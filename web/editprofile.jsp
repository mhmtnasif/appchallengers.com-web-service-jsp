        ...
        <form id="savepicture" action="SaveProfilPic" method="POST" data-toggle="validator" role="form" enctype="multipart/form-data">
            <div class="text-center">
                <div class="profile" style="margin-top: 30px">
                    ...
                    <img id="profil-pic" src="/images/defaultprofil.png"  class="daireselprofil">
                    <%}else{%>
            ...
            <button type="submit"  style="background-color: #fd5739;color:white" disabled="true" id="btn-save-profile" name="save-profile"
                    class="btn  btn-block" >Kaydet
            </button>
        </form>
        <form id="remove-profilpic" >
            <button type="submit" style="background-color: #fd5739;color:white"   id="btn-remove-profile" name="remove-profile"
                    class="btn  btn-block" >Prpfil Resmini Kaldır
            </button>
        </form>
    </div>
    <div class="col-sm-4"></div>
