...
<%
    ...
    try{
        ...
        userChallengeFeedList =challengesDetailDao.getUserChallengeFeedList(users.getId());
    }catch (Exception e){
            ...
            <div class="panel panel-default" id="p<%=feed.getChallenge_detail_id()%>">
                <div class="panel-heading " style="background-color: #fefefe">
                    <ul class="list-inline">
                        <li>
                            <a href="profile.jsp?ref=<%=feed.getChallenge_detail_user_id()%>"> <!-- jsp?=feed.getChallenge_detail_user_id()-->
                    ...
                    <ul class="list-inline">
                        <li>
                            <button type="button" style="color:#fd5739"  class="btn btn-default btn-sm" id="btnlike-<%=feed.getChallenge_detail_id()%>"><span id="likethumb-<%=feed.getChallenge_detail_id()%>"
                                   style="color:#fd5739"  class="glyphicon glyphicon-thumbs-up" ></span>Like
                            </button>
                        </li>
...
<script  type="text/javascript">
   ...
   $(document).ready(function () {
       var not=sessionStorage.getItem("notifi");
       if(not==null){
           sessionStorage.setItem("notifi","2");
       }else{
           if(not==1){
               $(".glyphicon-star").css("color","red");
           }
