...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scaleL=1, shrink-to-fit=no">
    <!-- Bootsrapt lins -->
            ...
            <div class="panel panel-default" style="min-height:min-content">    <!-- PANEL BEGINNIG -->
                ...
                <div class="panel-body">                      <!-- PANEL BODY BEGINNING-->
                    ...
                    <form method="POST" data-toggle="validator" role="form">
                        ...
                        <br>
                        <button type="submit" id="submitt" class="btn btn-block input-sm" style="background-color: #fd5739;color: white" name="btnlogin">
                            Giriş Yap
                        </button>
                    </form>
                    <br>
                    ...
                    <br>
                    <div class="text-center"><a style="color:#fd5739" href="forgotmypassword.jsp">Şifremi unuttum?</a></div>
                </div>                         <!-- PANEL ENDING -->
                <div class="panel-footer">     <!--PANEL FOOTER -->
                    <div class="text-center text-muted" style="color:#fd5739">Hesabın Yok mu? <a style="color:#fd5739" href="signup.jsp">Kaydol</a></div>
                </div>
            </div>
